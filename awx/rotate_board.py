...
# Snap the rotation centre to the 0.05 lattice (every routing grid), so an
...
CX, CY = round(CX / 0.05) * 0.05, round(CY / 0.05) * 0.05   # 0.05: the engines' strap grid too (0.025 shifted it by a half cell)
r = math.radians(deg)
