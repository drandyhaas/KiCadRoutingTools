    ...
    def _run_diff_routing(self, config, net_names):
        ...
        try:
            ...
            successful, failed, total_time, results_data = batch_route_diff_pairs(
                ...
                guide_corridor_layer=config.get('guide_corridor_layer', defaults.GUIDE_CORRIDOR_LAYER),
                guide_corridor_spacing=config.get('guide_corridor_spacing', defaults.GUIDE_CORRIDOR_SPACING),
