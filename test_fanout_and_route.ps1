...
# DDR on FPGA
python3 bga_fanout.py fanout_output3.kicad_pcb --component U3 --output fanout_output4.kicad_pcb --nets "*U1A*" "*U1B*" --primary-escape horizontal

# DDR on DDR chip
python3 bga_fanout.py fanout_output4.kicad_pcb --component U1 --output fanout_output5.kicad_pcb --nets "Net-(U1*DQS*)" "Net-(U1*CK*)" --diff-pairs "Net-(U1*DQS*)" "Net-(U1*CK*)"
python3 bga_fanout.py fanout_output5.kicad_pcb --component U1 --output fanout_output6.kicad_pcb --nets "*U1A*" --check-for-previous --primary-escape horizontal --layers F.Cu In1.Cu In2.Cu In3.Cu B.Cu
python3 bga_fanout.py fanout_output6.kicad_pcb --component U1 --output fanout_output.kicad_pcb --nets "*U1B*" --check-for-previous --layers F.Cu In1.Cu In2.Cu In3.Cu B.Cu
...
# Route RAM
python3 route.py test_diffpair.kicad_pcb output.kicad_pcb "Net-(U1*DQS*)" "Net-(U1*CK_*)" --diff-pairs "Net-(U1*DQS*)" "Net-(U1*CK_*)" --layers F.Cu In1.Cu In2.Cu In3.Cu B.Cu \
