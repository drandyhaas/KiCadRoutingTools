...
def main():
    ...
    if not quick: run('python3 route.py kicad_files/test_diffpair_ram.kicad_pcb kicad_files/test_diffpair_ram2.kicad_pcb "Net-(U1*)" --swappable-nets "Net-(U1*DQ*)" --layers F.Cu In1.Cu In2.Cu In3.Cu B.Cu --bga-proximity-radius 1 --stub-proximity-radius 1 --length-match-group auto --max-iterations 1000000')
