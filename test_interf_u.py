...
def main():
    ...
    run("python3 route.py kicad_files/interf_u_fanout.kicad_pcb kicad_files/interf_u_routed.kicad_pcb --no-bga-zone --layer-costs 1 1 --max-ripup 30 --stub-proximity-radius 10 --stub-proximity-cost 3.0 --track-proximity-cost 1.0 --max-iterations 10000000 --board-edge-clearance 0.55", unbuffered)
