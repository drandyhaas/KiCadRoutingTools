...
def main():
    ...
    options = "--track-width 0.2 --clearance 0.2 --via-size 0.5 --via-drill 0.4 --hole-to-hole-clearance 0.3 --stub-proximity-cost 1.0 --stub-proximity-radius 3.0 --max-iterations 1000000"
    if quick:
