...
def main():
    ...
    options = base_options+'--via-proximity-cost 10 --via-cost 50 --track-proximity-distance 0.5 --vertical-attraction-radius 0.5 --stub-proximity-cost 1.0 --stub-proximity-radius 4.0 --max-ripup 10 --max-iterations 10000000 '+power_nets
