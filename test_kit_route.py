...
def main():
    ...
    options = base_options+'--via-proximity-cost 100 --stub-proximity-cost 0.5 --stub-proximity-radius 4.0 --max-ripup 10 --max-iterations 10000000 --power-nets "*TB201*" --power-nets-widths 4.0 '
