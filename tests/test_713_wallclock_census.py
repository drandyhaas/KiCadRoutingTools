...
REGISTRY = {
    ...
    # (kicad_routing_plugin/deps_check.py: REMOVED by the IPC port along with
    # the SWIG entry point. Its clock -- pip/import probes of an external
