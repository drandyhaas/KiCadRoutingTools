...
def drc_clean(board, pattern):
    ...
    # --baseline BOARD (#962): routed_output (a routed fixture) already has 339
    # vias in BGA paste openings, 4 of them on these pairs' nets. They are the
    # input's, not this route's, so they are accepted as inherited.
