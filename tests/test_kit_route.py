...
def main():
    ...
    options = base_options+'--proximity-heuristic-factor 0.0 --via-proximity-cost 10 --via-cost 50 --track-proximity-distance 3.0 --track-proximity-cost 0.2 --vertical-attraction-radius 0 --stub-proximity-cost 2.0 --stub-proximity-radius 4.0 --max-ripup 10 --max-iterations 10000000 '+power_nets
